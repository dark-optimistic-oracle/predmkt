...
Post-upgrade reads preserved market `187031921field`, collateral `300000u128`,
YES supply `200000u128`, NO supply `100000u128`, and `resolved = false`. The new
`settlement_assertions` entry is absent until settlement.
